    ...
    <main class="flex-1 p-6 md:p-10 lg:p-12 max-w-[1600px] mx-auto w-full">
        ...
        <div class="group relative overflow-hidden bg-gradient-to-br from-blue-600 to-indigo-700 p-10 rounded-[2.5rem] text-white mb-10 smooth-shadow transition-transform hover:scale-[1.005]">
            <div class="relative z-10">
                ...
                <p class="text-blue-100 font-medium max-w-xl opacity-90 text-sm leading-relaxed">Pantau ketersediaan stok obat secara real-time sebelum memberikan informasi kepada pasien atau pelanggan.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 text-xs">
